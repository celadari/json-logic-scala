...
import com.celadari.jsonlogicscala.serialize.impl._
import com.celadari.jsonlogicscala.serialize.SerializerConf.DEFAULT_MARSHALLERS
import com.celadari.jsonlogicscala.serialize
...
class TestSerializerConf extends AnyFlatSpec with Matchers {
  ...
  "createConf default path" should "return conf" in {
    ...
    val expectedResult = serialize.SerializerConf(Map(
  ...
  "createConf non marshaller object" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found object is not a 'com.celadari.jsonlogicscala.serialize.Marshaller' instance:
        |'com.celadari.jsonlogicscala.deserialize.impl.UnmarshallerIntImpl$'""".stripMargin
  ...
  "createConf non singleton with singleton true in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No singleton object found for: 'com.celadari.jsonlogicscala.serialize.impl.MarshallerStringImpl'
        |Check if 'className' 'com.celadari.jsonlogicscala.serialize.impl.MarshallerStringImpl' is correct and if 'singleton' property""".stripMargin +
  ...
  "createConf non marshaller class" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found class is not a 'com.celadari.jsonlogicscala.serialize.Marshaller' instance:
        |'com.celadari.jsonlogicscala.deserialize.impl.UnmarshallerDoubleImpl'""".stripMargin
    thrown.getMessage shouldBe expectedMessage
  }
  ...
  "createConf singleton with singleton false in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No class found for: 'com.celadari.jsonlogicscala.serialize.impl.MarshallerIntImpl'
        |Check if 'className' 'com.celadari.jsonlogicscala.serialize.impl.MarshallerIntImpl' is correct and if 'singleton' property""".stripMargin +
  ...
  "createConf wrong constructor argument names in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """Field error, check that no field in 'com.celadari.jsonlogicscala.serialize.impl.MarshallerStringImpl2' is missing in 'string' property file.
        |Check that no property in 'string' file is not undefined in 'com.celadari.jsonlogicscala.serialize.impl.MarshallerStringImpl2' class.
        |Check if 'com.celadari.jsonlogicscala.serialize.impl.MarshallerStringImpl2' class constructor requires arguments or if """.stripMargin +
