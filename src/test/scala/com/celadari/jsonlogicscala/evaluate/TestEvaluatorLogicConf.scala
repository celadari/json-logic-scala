...
import com.celadari.jsonlogicscala.tree.types.DefaultTypes.{DOUBLE_CODENAME, INT_CODENAME, STRING_CODENAME}
import com.celadari.jsonlogicscala.evaluate.EvaluatorLogicConf.DEFAULT_METHOD_CONFS
import com.celadari.jsonlogicscala.tree.types.{ArrayTypeValue, SimpleTypeValue}
import com.celadari.jsonlogicscala.evaluate.impl._
...
class TestEvaluatorLogicConf extends AnyFlatSpec with Matchers {
  ...
  "createConf EvaluateValueLogic non EvaluateValueLogic object" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found object is not a 'com\.celadari\.jsonlogicscala\.evaluate\.EvaluatorValueLogic' instance:
        |'(?:class\s)?com\.celadari\.jsonlogicscala\.deserialize\.impl\.UnmarshallerIntImpl\$'""".stripMargin
  ...
  "createConf EvaluateValueLogic non singleton with singleton true in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No singleton object found for: 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplInt'
        |Check if 'className' 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplInt' is correct and if 'singleton'""".stripMargin +
  ...
  "createConf EvaluateValueLogic non marshaller class" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found class is not a 'com\.celadari\.jsonlogicscala\.evaluate\.EvaluatorValueLogic' instance:
        |'(?:class\s)?com\.celadari\.jsonlogicscala\.deserialize\.impl\.UnmarshallerDoubleImpl'""".stripMargin
    thrown.getMessage should fullyMatch regex expectedMessage
  }
  ...
  "createConf EvaluateValueLogic singleton with singleton false in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No class found for: 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplDouble'
        |Check if 'className' 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplDouble' is correct and if 'singleton'""".stripMargin +
  ...
  "createConf EvaluateValueLogic wrong constructor argument names in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """Field error, check that no field in 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplFloat' is missing in""" +
      """ 'float' property file.
        |Check that no property in 'float' file is not undefined in 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplFloat' class.
        |Check if 'com.celadari.jsonlogicscala.evaluate.impl.EvaluatorValueLogicImplFloat' class constructor requires arguments or if""".stripMargin +
  ...
  "createConf MethodConf non EvaluateValueLogic object" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found object is not 'com\.celadari\.jsonlogicscala\.evaluate\.Operator' type:
        |(?:class\s)?com\.celadari\.jsonlogicscala\.evaluate\.impl\.EvaluatorValueLogicImplString\$ cannot be cast to""".stripMargin +
        """ (?:class\s)?com\.celadari\.jsonlogicscala\.evaluate\.Operator[\S\s]*""".stripMargin
    thrown.getMessage should fullyMatch regex expectedMessage
  }
  ...
  "createConf MethodConf non singleton with singleton true in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No singleton object found for: 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplPrefix'
        |Check if 'ownerMethod' 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplPrefix' is correct and if 'singleton' property""".stripMargin +
  ...
  "createConf MethodConf non marshaller class" should "throw an exception" in {
    ...
    val expectedMessage =
      """Found class not 'com\.celadari\.jsonlogicscala\.evaluate\.Operator' instance:
        |(?:class\s)?com\.celadari\.jsonlogicscala\.evaluate\.impl\.EvaluatorValueLogicImplInt cannot be cast to""".stripMargin +
        """ (?:class\s)?com\.celadari\.jsonlogicscala\.evaluate\.Operator([\s\S])*"""
    thrown.getMessage should fullyMatch regex expectedMessage
  }
  ...
  "createConf MethodConf singleton with singleton false in props file" should "throw an exception" in {
    ...
    val expectedMessage =
      """No class found for: 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplGreater'
        |Check if 'ownerMethod' 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplGreater' is correct and if 'singleton'""".stripMargin +
  ...
  "createConf MethodConf wrong constructor argument names in props file" should "throw an exception" in {
    ...
    val expectedMessage = """Field error, check that no field in 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplSurroundString' is""" +
      """ missing in 'surround' property file.
        |Check that no property in 'surround' file is not undefined in 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplSurroundString' class.
        |Check if 'com.celadari.jsonlogicscala.evaluate.impl.OperatorImplSurroundString' class constructor requires arguments or if""".stripMargin +
